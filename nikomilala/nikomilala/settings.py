"""
Django settings for nikomilala project.
...
SECRET_KEY = 'django-insecure-o@3@gagub(p)t758=8pscti0iieee&7ze&7t^mr3pba(+errr('
...
WSGI_APPLICATION = 'nikomilala.wsgi.application'
